...
export function Navbar2() {
  ...
  return (
    ...
    >
      <div className="global-container flex h-24 sm:h-28 items-center justify-between">
        ...
        <nav className="hidden items-center gap-2 md:flex">
          {navLinks.map((link) => (
            <a
              ...
              className="group relative rounded-full px-4 py-2.5 text-lg font-semibold text-[#101828] transition-all duration-200 hover:text-[#2563EB]"
            >
        ...
        <div className="hidden items-center gap-3 md:flex">
          <a
            href="/contact"
            className="group inline-flex items-center justify-center gap-2 rounded-full bg-[#2563EB] px-7 py-3.5 text-lg font-semibold text-white shadow-sm transition-all duration-200 hover:bg-blue-700 hover:scale-[1.02] active:scale-[0.98]"
          >
