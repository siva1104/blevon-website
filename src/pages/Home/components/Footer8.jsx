...
const CONTACT_PHONE =
  import.meta.env.VITE_CONTACT_PHONE || "+91 9491229471";
      ...
      <div className="global-container">
        ...
        <div className="grid grid-cols-1 gap-8 pb-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_0.8fr_0.8fr_1fr] lg:gap-12">
          ...
          <div className="flex flex-col items-start">
            ...
            {/* Direct Contact Actions below logo */}
            <div className="mt-4 flex flex-wrap items-center gap-2">
              <a
                href={`mailto:${CONTACT_EMAIL}`}
                title="Send us an email: contact@blevon.in"
                aria-label="Send us an email: contact@blevon.in"
                className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs font-semibold text-[#60A5FA] transition-all duration-200 hover:border-[#60A5FA] hover:bg-blue-500/20 active:scale-95"
              >
                <svg
                  viewBox="0 0 24 24"
                  width="13"
              ...
              <a
                ...
                title="Call us: +91 9491229471"
                aria-label="Call us: +91 9491229471"
                className="inline-flex items-center gap-1.5 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs font-semibold text-[#60A5FA] transition-all duration-200 hover:border-[#60A5FA] hover:bg-blue-500/20 active:scale-95"
              >
                <svg
                  viewBox="0 0 24 24"
              ...
              <a
                ...
                title="Chat on WhatsApp: +91 9491229471"
                aria-label="Chat on WhatsApp: +91 9491229471"
                className="inline-flex items-center gap-1.5 rounded-full border border-emerald-400/30 bg-emerald-500/10 px-3 py-1 text-xs font-semibold text-[#25D366] transition-all duration-200 hover:border-[#25D366] hover:bg-emerald-500/20 active:scale-95"
              >
                <svg
                  viewBox="0 0 24 24"
                  width="13"
