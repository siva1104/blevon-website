...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F8F6] text-[#101828]">
      ...
      <main>
        {/* 2. Header Section */}
        <section className="relative w-full pt-12 pb-12 text-center sm:pt-16 sm:pb-16">
        ...
        <section className="relative w-full pb-16 md:pb-24">
          <div className="mx-auto w-full max-w-[1800px] px-6 sm:px-8">
            <div className="grid grid-cols-1 items-stretch gap-8 lg:grid-cols-2 lg:gap-10">
              ...
              {/* ============================================================ */}
              <div className="flex h-full flex-col justify-between rounded-3xl border border-[#E4E7EC] bg-white p-7 sm:p-9 lg:p-10 shadow-sm transition-all duration-300 hover:border-blue-300">
                <div className="flex flex-1 flex-col justify-between">
                  {/* Action Header */}
                  <div>
                    <div className="mb-6 flex items-center justify-between border-b border-[#E4E7EC] pb-5">
                      <div>
                        <span className="inline-block text-xs font-bold tracking-[0.2em] text-[#2563EB] uppercase sm:text-sm">
                          Action 01
                        </span>
                        <h2 className="mt-1 text-2xl font-bold tracking-tight text-[#101828] sm:text-3xl">
                          Book a Call
                        </h2>
                      </div>
                      <span className="inline-flex items-center rounded-full border border-blue-200 bg-[#EAF1FF] px-3.5 py-1 text-xs font-semibold text-[#2563EB] sm:text-sm">
                        30 Min Discovery
                      </span>
                    </div>

                    <p className="mb-6 min-h-[48px] text-base text-[#667085] sm:text-lg leading-relaxed">
                    ...
                    >
                      <div className="space-y-6">
                        ...
                        <div>
                          <div className="mb-3 flex items-center justify-between">
                            <label className="text-xs font-semibold tracking-wider text-[#101828] uppercase sm:text-sm">
                              1. Select Date
                            </label>
                            <span className="text-xs text-[#667085]">Monday – Saturday</span>
                          </div>
                            ...
                            {availableDates.slice(0, 10).map((d) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`flex flex-col items-center justify-center rounded-xl sm:rounded-2xl border p-1.5 sm:p-3 text-center transition-all duration-200 focus:outline-none ${
                                    isSelected
                                      ? "border-[#2563EB] bg-[#2563EB] text-white shadow-xs"
                                      : "border-[#E4E7EC] bg-[#F7F8F6] text-[#101828] hover:border-blue-300 hover:bg-white"
                                  }`}
                                >
                                  <span className={`text-[9px] sm:text-[11px] font-medium uppercase ${isSelected ? "text-blue-100" : "text-[#667085]"}`}>
                                    {d.dayName}
                                  </span>
                                  <span className="text-sm sm:text-base md:text-lg font-bold">
                                    {d.dayNum}
                                  </span>
                                  <span className={`text-[9px] sm:text-[10px] ${isSelected ? "text-blue-200" : "text-[#94A3B8]"}`}>
                                    {d.monthName}
                                  </span>
                                </button>
                              );
                            ...
                            {AVAILABLE_TIME_SLOTS.map((slot) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`rounded-xl border px-3 py-2.5 text-xs sm:text-sm font-semibold transition-all duration-200 focus:outline-none ${
                                    isSelected
                                      ? "border-[#2563EB] bg-[#2563EB] text-white shadow-xs"
                                      : "border-[#E4E7EC] bg-[#F7F8F6] text-[#101828] hover:border-blue-300 hover:bg-white"
                                  }`}
                        ...
                        {/* Selected Summary */}
                        <div className="rounded-2xl border border-[#E4E7EC] bg-[#F7F8F6] p-4 text-sm text-[#101828]">
                      ...
                      <div className="pt-2">
                        <button
                          ...
                          className="group inline-flex w-full items-center justify-center gap-2 rounded-full bg-[#2563EB] py-4 text-base font-semibold text-white shadow-[0_4px_14px_rgba(37,99,235,0.28)] transition-all duration-300 hover:bg-blue-700 hover:shadow-[0_6px_20px_rgba(37,99,235,0.4)] active:scale-[0.99] sm:text-lg"
                        >
                    ...
                    >
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                          <div>
                            <label className="block text-xs font-semibold tracking-wider text-[#101828] uppercase mb-1.5">
                              Full Name *
                            </label>
                            <input
                              type="text"
                              ...
                              className="w-full rounded-xl border border-[#E4E7EC] bg-[#F7F8F6] px-4 py-3 text-base text-[#101828] placeholder:text-[#94A3B8] transition-colors focus:border-[#2563EB] focus:bg-white focus:outline-none focus:ring-1 focus:ring-[#2563EB]"
                            />
                          </div>
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full rounded-xl border border-[#E4E7EC] bg-[#F7F8F6] px-4 py-3 text-base text-[#101828] transition-colors focus:border-[#2563EB] focus:bg-white focus:outline-none focus:ring-1 focus:ring-[#2563EB]"
                          >
                            <option value="Website Development">Website Development</option>
                            <option value="App Development">App Development</option>
                            <option value="Full Digital Product">Full Digital Product (Web + App)</option>
                            <option value="Other Consulting">Other Inquiries</option>
                          </select>
                        </div>
                ...
                <div className="flex flex-1 flex-col justify-between">
                  ...
                  <div>
                    <div className="mb-6 flex items-center justify-between border-b border-[#E4E7EC] pb-5">
                      ...
                      <span className="inline-flex items-center rounded-full border border-[#E4E7EC] bg-[#F7F8F6] px-3.5 py-1 text-xs font-semibold text-[#667085] sm:text-sm">
                        Direct Message
                      </span>
                    </div>
                  ...
                  {enquiryStatus === "success" ? (
                    ...
                    <form onSubmit={handleEnquirySubmit} className="flex flex-1 flex-col justify-between space-y-4">
                      <div className="space-y-4">
                        {enquiryError && (
                          <div className="rounded-xl border border-red-200 bg-red-50 p-3 text-sm text-red-700">
                            {enquiryError}
                      ...
                      <div className="pt-2">
                        <button
                          ...
                          className="group inline-flex w-full items-center justify-center gap-2 rounded-full border border-[#D0D5DD] bg-white py-4 text-base font-semibold text-[#0E2A6D] shadow-xs transition-all duration-300 hover:border-blue-300 hover:bg-[#EAF1FF] hover:text-[#2563EB] active:scale-[0.99] disabled:opacity-50 sm:text-lg"
                        >
            ...
            {/* ============================================================ */}
            <div className="mt-12 rounded-3xl border border-[#E4E7EC] bg-white p-6 sm:p-8 shadow-sm">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div>
                  <span className="text-xs font-bold tracking-[0.2em] text-[#2563EB] uppercase sm:text-sm">
                    Direct Contact
                  </span>
                  <h3 className="mt-1 text-xl font-bold text-[#101828] sm:text-2xl">
                ...
                <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2.5 rounded-full border border-[#E4E7EC] bg-[#F7F8F6] px-5 py-3 text-sm sm:text-base font-semibold text-[#101828] transition-all duration-200 hover:border-blue-300 hover:bg-[#EAF1FF] hover:text-[#2563EB] active:scale-[0.98]"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      className="size-5 fill-none stroke-current stroke-2 text-[#2563EB]"
                      strokeLinecap="round"
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2.5 rounded-full border border-[#E4E7EC] bg-[#F7F8F6] px-5 py-3 text-sm sm:text-base font-semibold text-[#101828] transition-all duration-200 hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700 active:scale-[0.98]"
                  >
                    <svg
                      viewBox="0 0 24 24"
                      className="size-5 fill-[#25D366]"
                      aria-hidden="true"
                    >
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2.5 rounded-full border border-[#E4E7EC] bg-[#F7F8F6] px-5 py-3 text-sm sm:text-base font-semibold text-[#101828] transition-all duration-200 hover:border-blue-300 hover:bg-[#EAF1FF] hover:text-[#2563EB] active:scale-[0.98]"
                  >
                    <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#2563EB]">
