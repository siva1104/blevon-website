  ...
  return (
    <div className="min-h-screen bg-[#F7F8F6] text-[#101828]">
      ...
      <main className="pt-20 sm:pt-22 md:pt-24">
        {/* 2. Header */}
        <section className="relative w-full pt-6 pb-6 text-center sm:pt-8 sm:pb-10">
          <div className="global-container">
            <div className="mx-auto max-w-xl">
              <span className="mb-2 inline-block text-xs font-semibold tracking-[0.2em] text-[#2563EB] uppercase">
                WORK
              </span>
              <h1 className="mb-2.5 text-xl font-bold tracking-tight text-[#101828] sm:text-2xl md:text-3xl lg:text-[34px] leading-[1.18]">
                Selected work.
              </h1>
              <p className="mx-auto max-w-lg text-xs text-[#667085] sm:text-sm leading-relaxed">
        ...
        <section className="relative w-full pb-12 md:pb-16">
          <div className="global-container">
            <div className="mx-auto w-full max-w-xl md:max-w-2xl lg:max-w-[680px]">
                ...
                >
                  ...
                  <div className="flex flex-col justify-between h-full">
                    <div>
                      ...
                      {/* Project Title */}
                      <h2 className="mt-1 text-base font-bold tracking-tight text-[#101828] sm:text-lg leading-[1.2] uppercase">
                        {project.name}
                      </h2>
                  ...
                  <div className="overflow-hidden rounded-xl border border-[#E4E7EC] bg-[#F7F8F6]">
                    <a
                      href={project.link || "/case-study"}
                      className="flex aspect-[16/10] w-full items-center justify-center p-5 sm:p-6 focus:outline-none transition-transform duration-700 group-hover:scale-105"
                    >
                      <img
                        src={project.logo || project.image}
                        alt={`${project.name} client logo`}
                        className="max-h-12 sm:max-h-14 w-auto max-w-[85%] object-contain"
                        loading="lazy"
                      />
                    </a>
                  </div>
