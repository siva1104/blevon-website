...
export default function DeleteDialog({ isOpen, onClose, onConfirm, title, isLoading }: DeleteDialogProps) {
      ...
      <div className="relative bg-white rounded-[24px] border border-[#E2E8F0] max-w-sm w-full p-6 shadow-[0_12px_40px_rgba(0,0,0,0.06)] z-10 space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-3">
          ...
          <p className="text-[13.5px] leading-relaxed text-slate-500 font-medium">
            Are you sure you want to delete <strong className="font-bold text-[#0f172a]">&ldquo;{title}&rdquo;</strong>? This will remove the case study and delete its media assets from Storage permanently.
          </p>
        </div>
